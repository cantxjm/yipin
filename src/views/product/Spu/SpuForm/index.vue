...
export default {
  ...
  data() {
    return {
      ...
      //添加SPU，如果是添加SPU的时候并没有向服务器发请求，数据收集到哪里呀[SPU]，收集数据的时候有哪些字段，看文档
      spu: {
        //三级分类的id
        category3Id: 0,
        //描述
      ...
      saleAttrList: [], //销售属性的数据(项目的全部销售属性)
      attrIdAndAttrName: "", //收集选择的销售属性的id
    };
  },
  methods: {
    // 照片墙删除某一个图片的时候会触发
    ...
    handleInputConfirm(row) {
      ...
      // 修改 inputVisible 的值为false,不显示button
